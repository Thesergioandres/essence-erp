  ...
  async generateWithFallback(prompt) {
    ...
    for (const modelName of MODELS_TO_TRY) {
      try {
        ...
        console.warn(`âš ï¸ Falló modelo ${modelName}:`, error.message);
...
4.  **ðŸš€ Acción Prioritaria (Solo UNA):**
    *   Â¿Qué es lo *único* mas importante que el dueño debería hacer HOY para mejorar la rentabilidad? Sé imperativo y accionable.
